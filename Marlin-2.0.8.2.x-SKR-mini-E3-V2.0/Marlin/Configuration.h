 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 2 // Siarial port для экрана
 ...
 */
#define BAUDRATE 115200 // скорость Siarial port для экрана
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 // Siarial port для USB
...
#define CUSTOM_MACHINE_NAME "MAKERPI P2"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT_Z  (200/4/32)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT_E0 190
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, DEFAULT_AXIS_STEPS_PER_UNIT_Z, DEFAULT_AXIS_STEPS_PER_UNIT_E0 }
